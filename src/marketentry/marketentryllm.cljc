(ns marketentry.marketentryllm
  ...
  the Federated States of Micronesia (FSM) public-sector market-entry
  compliance actor.
...
(defn- propose-submit
  ...
  (let [e (store/engagement db subject)]
    {:summary    (str subject " 向けポータル提出提案"
                      (when e (str " (operator=" (:operator e) ")")))
     :rationale  (if e
                   (str "citizen-bidder?=" (:citizen-bidder? e)
                        " pct-fsm-ownership=" (:pct-fsm-ownership e)
                        " fsm-resident-1yr?=" (:fsm-resident-1yr? e)
                        " paid-fsm-gross-revenue-tax-1yr?=" (:paid-fsm-gross-revenue-tax-1yr? e)
                        " claimed-preference-pct=" (:claimed-preference-pct e)
                        " fsm-tax-filing-verified?=" (:fsm-tax-filing-verified? e)
     ...
     :confidence (if (and e
                          (or (not (:requires-fsm-tax-filing? e))
                              (:fsm-tax-filing-verified? e)))
                   0.9 0.3)}))
